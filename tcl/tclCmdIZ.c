...
#ifndef lint
static char rcsid[] = "$Header: /sprite/src/lib/tcl/RCS/tclCmdIZ.c,v 1.30 90/01/31 09:21:58 ouster Exp Locker: ouster $ SPRITE (Berkeley)";
#endif not lint
    ...
    char **argv;			/* Argument strings. */
{
    ...
    /*888888888888 added by me rania */ #define O_RDONLY 0
